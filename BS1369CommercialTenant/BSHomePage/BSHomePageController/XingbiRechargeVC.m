...
- (void)setNavigation {
    BSSetNavigationView *navg = [BSSetNavigationView navigationWithLeftImageName:@"fanhui" centerTitleName:@"星币充值" andFrame:CGRectMake(0, 20, ScreenWidth, 44)];
...
- (void)viewWillAppear:(BOOL)animated {
    UIButton *buttag = [self.view viewWithTag:1234];
    buttag.userInteractionEnabled = YES;
}
